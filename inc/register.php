<?php
//Page which lets you register a new account in the system. Username and Password are stored in a text file
//The passwords as not hashed for the sake of simplicity and showing functionality
@session_start();
